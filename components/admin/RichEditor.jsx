...
export default function RichEditor({ value, onChange }) {
  ...
  return (
    <div className="rounded-lg border border-stone-200 bg-white">
      ...
      <p className="border-t border-stone-200 p-3 text-xs text-stone-500">💡 Tip: Click Image icon to upload from computer, or use Image URL to paste external URLs</p>
    </div>
  );
}
